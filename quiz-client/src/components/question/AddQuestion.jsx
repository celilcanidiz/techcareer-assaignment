				...
				<div className="col-md-6  mt-5">
					<div className="card">
						<div className="card-header">
							<h5 className="card-title">Yeni Soru Ekle</h5>
						</div>
							...
							<form onSubmit={handleSubmit} className="p-2">
								...
								<div className="mb-3">
									...
									<select
										...
										className="form-control">
										<option value="single">Tek Doğru Cevap</option>
										<option value="multiple">Çoklu Doğru Cevap</option>
									</select>
								</div>
								<div className="mb-3">
								...
								{!correctAnswers.length && <p>Lütfen en az bir doğru cevap giriniz.</p>}
